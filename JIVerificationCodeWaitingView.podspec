...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JIVerificationCodeWaitingView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jerryelectricity@me.com/JIVerificationCodeWaitingView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jerryelectricity@me.com' => 'YangZongwei@csvw.com' }
  s.source           = { :git => 'https://github.com/jerryelectricity@me.com/JIVerificationCodeWaitingView.git', :tag => s.version.to_s }
